...
export type SettingsSection = 'general' | 'transcript-generator' | 'properties' | 'highlighter' | 'interpreter' | 'reader' | 'templates';
...
export function initializeSidebar(): void {
	...
	if (sidebar) {
		sidebar.addEventListener('click', (event) => {
			...
			if (section === 'general'
				|| section === 'transcript-generator'
				|| section === 'properties'
				|| section === 'highlighter'
				|| section === 'interpreter'
				|| section === 'reader') {
				showSettingsSection(section as 'general' | 'transcript-generator' | 'properties' | 'highlighter' | 'interpreter' | 'reader');
			}
